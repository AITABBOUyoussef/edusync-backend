...
<div class="max-w-md mx-auto mt-10 bg-white p-8 border border-gray-200 rounded-lg shadow-sm">
    ...
    <form action='inscription.php' method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="email" class="w-full border border-gray-300 p-2 rounded focus:outline-none focus:border-pink-500" >
        </div>

        <div class="mb-6">
            <label class="block text-gray-700 font-medium mb-2">Mot de passe</label>
            <input type="password" name="password" class="w-full border border-gray-300 p-2 rounded focus:outline-none focus:border-pink-500" >
        </div>
